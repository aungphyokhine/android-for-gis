...
public class PostAsyncFriendRequest {

	PostHttpClient jsonParser;
	private Context context;
	private ProgressDialog pDialog;
	private static final String URL = "https://express4-gistracker.rhcloud.com/request/add";

	public PostAsyncFriendRequest(Context context, final OnResults listener) {
		super();
