...
public class PostAsyncFriendRemove {

	PostHttpClient jsonParser;
	private Context context;
	private ProgressDialog pDialog;
	private static final String URL = "https://express4-gistracker.rhcloud.com/request/remove";

	public PostAsyncFriendRemove(Context context, final OnResults listener) {
		super();
	...
	public void execute(String... arg0) {
		...
		try {
			...
			String t;
			String params = "{\"request\": {\"to_uid\":\"" + arg0[0] + "\"},\"token\" :\"" + arg0[1] + "\"" + "}";
			 ...
			 * 
			 * 
			 * params.put("name", args[0]); params.put("password", args[1]);
			 */
